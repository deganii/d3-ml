...
model_folder = '../../models/m-20-mnist-comparison/'
...
with tf.Session() as sess:
    ...
    while step * batch_size < training_iters:
        ...
        if step % display_step == 0:
            ...
            train_loss_dt.append(loss)
            train_acc_dt.append(acc)
            ...
            np.savetxt(model_folder + "performance.csv", np.transpose(perf_data), fmt='%10.4f', header=header,
                       delimiter=',')
